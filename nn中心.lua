...
local bin = creds:section("玩家信息",true)
    ...
    bin:Label("更新:河北唐县,doors,刀刃球,一路向西,巴掌模拟器")
    bin:Label("更新时间:6月30日")
    bin:Label("永久免费：免费")
...
endcredits:Button("改地图(floor2)",function()
...
credits:Button("碎片模式V4",function()
...
local creds = window:Tab("刀刃球",'18255612747')
local credits = creds:section("脚本",true)
...
local creds = window:Tab("一路向西",'18255612747')
local credits = creds:section("脚本",true)
credits:Button("1",function()
    loadstring(game:GetObjects("rbxassetid://10040701935")[1].Source)()
end)
local creds = window:Tab("巴掌模拟器",'18255612747')
local credits = creds:section("脚本",true)
